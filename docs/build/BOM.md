...
### Optional - Case plates
 ...
 - The MCU's and the Solenoid are taller than the key plate, so they have their own separate taller plates cover plates. Acrylic, PCB or 3d prints are good for these.
